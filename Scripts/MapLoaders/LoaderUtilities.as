...
TileType server_onTileHit(CMap@ map, f32 damage, u32 index, TileType oldTileType)
{
	if(map.getTile(index).type > 255)
	{
		...
		{	
			...
			case CMap::tile_goldenbrick_d5: {OnGoldTileHit(map, index); return oldTileType + 1;}		
			case CMap::tile_goldenbrick_d6: {OnGoldTileDestroyed(map, index); return CMap::tile_empty;}
			...
			case CMap::tile_steelbrick_d9: {OnGoldTileHit(map, index); return oldTileType + 1;}		
			case CMap::tile_steelbrick_d10: { OnGoldTileDestroyed(map, index); return CMap::tile_empty;}	
